...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.c0er43aopeim.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'mehmetblog' # please enter your s3 bucket name
